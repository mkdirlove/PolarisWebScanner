...
def web_vulnerability_scan(website_url):
    ...
    subprocess.check_output(['python3', 'web-vulnerability-scanner.py', 'full', website_url])
    subprocess.check_output(['python3', 'wap.py', '-u', website_url ,'-wf', report_file_name])
    subprocess.check_output(['python3', 'virus-total.py', website_url , report_file_name])
